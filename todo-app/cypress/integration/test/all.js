context("Actions", () => {
    ...
    describe("todo app", () => {
        ...
        it('.clear() - clears an input or textarea element', () => {
            ...
            cy.get('#textForm').type('Clear this text')
        ...
        it('add() - clears an input or textarea element', () => {
            ...
            cy.get('#textForm').type('Hello World')
        ...
        it('Delete() -Elimina el primer elemento', () => {
            ...
            cy.get('.todo__state:first').check({
                force: true
            }).should('be.checked')
        ...
        it('Delete() -Elimina todos los elementos', () => {
            ...
            cy.get('#textForm').type('Hello World 1')
            ...
            cy.get('#textForm').type('Hello World 2')
